...
if [ -f "$CONFIG_FILE" ]; then
    ...
    LIBS="${STAGING_DIR}/lib/libpng.a;${STAGING_DIR}/lib/libjpeg.a;${STAGING_DIR}/lib/libjpeg12.a;${STAGING_DIR}/lib/libtiff.a;${STAGING_DIR}/lib/libwebp.a;${STAGING_DIR}/lib/libsharpyuv.a;${STAGING_DIR}/lib/libz.a;m"
